...
/*
**Allow users to change or remove the call to action on the Homepage and add extra options for the header image
*/
...
function kickstarter_customize_register_banner_and_header( $wp_customize ) {
    ...
    $wp_customize->add_section('banner_options', array(
        ...
        'description' => esc_html__( 'Customize the Call to Action Button on the Homepage. 
    ...
    $wp_customize->add_control(
        ...
        */
        ...
        $wp_customize->add_section('header_image', array(
            'title' => esc_html__('Header Image', 'kickstarter'),
            'description' => esc_html__( 'Add custom header image and customize it to taste with the options below. Change width, height and position of the image. Choose to add or remove the parallax effect of the image.', 'kickstarter' ),
            'priority' => 99
        )); 
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'section'         => 'header_image',
                'description' => esc_html__('Change the height of the header image.', 'kickstarter'),
            )
        );
        ...
        $wp_customize->add_control(
            'header_image_overlay',
            array(
                'label'           => esc_html__( 'Header Image Overlay', 'kickstarter' ),
                'section'         => 'header_image',
                'description' => esc_html__('Add overlay to the header.', 'kickstarter'),
                'type' => 'checkbox'
            )
        );
}
